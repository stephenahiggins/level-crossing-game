...
import type { LevelCrossingRecord } from '../lib/types';
...
export const api = createApi({
  ...
  tagTypes: ['Scores', 'Me', 'Crossings'],
  endpoints: (builder) => ({
    getCrossings: builder.query<LevelCrossingRecord[], void>({
      query: () => ({
        url: `/crossings`,
      }),
      providesTags: [{ type: 'Crossings', id: 'LIST' }],
    }),
